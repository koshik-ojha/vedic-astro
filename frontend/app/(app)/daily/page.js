    ...
    <div className="p-6 lg:p-10">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-2">
          <MdWbSunny className="text-orange-400" size={32} />
          Daily Astrology
        </h1>
        <p className="text-gray-500 mt-1">Today&apos;s cosmic insights, personalised for you</p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="card">
          ...
          <button
            onClick={getReading}
            disabled={loading}
            className="w-full mt-6 py-3 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white font-semibold rounded-xl transition-colors"
          >
