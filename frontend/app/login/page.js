  ...
  return (
    <>
      <style>{`
        ...
        .va-brand { text-align: center; margin-bottom: 2rem; }
        ...
        <div className="va-card">
          <div className="va-inner">
            ...
            <div className="va-brand">
              <svg width="64" height="64" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="va-brand-title">Vedic Astro</div>
              <div className="va-brand-sub">Read the stars. Know thyself.</div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" disabled={loading} className="va-btn">
                {loading ? "CONSULTING THE STARS..." : "ENTER THE COSMOS"}
              </button>
            </form>
